...
st.write("""The purpose of this app is to predict the bioactivity of CD73 inhibitors using molecular descriptors from the PaDEL-Descriptor software.
         These features are then used to train a machine learning model on the ChEMBL Database. The user can input a molecule in the form of a SMILES string or upload a file containing multiple molecules.""")
# Logo image
